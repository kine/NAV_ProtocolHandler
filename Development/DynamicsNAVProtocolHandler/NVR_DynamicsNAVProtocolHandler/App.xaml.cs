...
namespace NVR_DynamicsNAVProtocolHandler
{
    ...
    public partial class App : Application
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (Path.GetFileName(activeProcess).ToLower() == "finsql.exe")
                    {
                        ...
                        {
                            RunProcess(path + "Microsoft.Dynamics.Nav.Client.exe", @"""" + args + @"""");
                            return;
                        }
                    ...
                    else
                    {
                        ...
                        RunProcess(defaultPath.Replace(@" ""%1""", ""), @"""" + args + @"""");
                        return;
                        //Use Default
                    }
                }
        ...
        private string FindNavClient(string fileVersion,string currentFolder)
        {
            string fileName = "";
        ...
        private void RunProcess(string path, string param)
        {
